...
# SBATCH --time=0-5:30:00             # 7 days by default on htc partition
# SBATCH --array=1-50
...
python /pbs/throng/lsst/users/cpayerne/ClusterLikelihoods/modules/pinocchio_analysis/compute_posteriors_per_block.py $N_Z_BIN $N_M_BIN GaussianCholesky $START_NUM $END_NUM 
