...
dat=edit.load_pickle(f'/sps/lsst/users/cpayerne/1000xsimulations/analysis/binned_catalogs/{n_z_bin}x{n_logm_bin}_binned_catalogs_fsky_div_10.pkl')
...
key=f'{n_z_bin}zx{n_logm_bin}m/tabulated_model_fsky_div_10/{n_z_bin}x{n_logm_bin}_sampled_abundance'
where=where_tab+key+'*'
Nth, Om, s8, q_val=[],[],[],[]
...
t = Table()
where=f'/sps/lsst/users/cpayerne/1000xsimulations/analysis/{n_z_bin}zx{n_logm_bin}m/mean_dispersion_fsky_div_10/'
...
print('computing...')
mean_Om, mean_s8, covar = Oms8.compute_mean_covariance_importance_sampling(lnposterior, Nobs, Nth, 
