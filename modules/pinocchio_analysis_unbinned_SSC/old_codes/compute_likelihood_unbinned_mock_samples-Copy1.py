...
nbins_bybrid = analysis.analysis_unbinned['number_bins_hybrid'][int(index_analysis)]
...
if likelihood == 'full_unbinned_SSC' or likelihood == 'standard_unbinned':
...
if mcmc==False:
    ...
    name_save = f'/pbs/throng/lsst/users/cpayerne/LikelihoodsClusterAbundance/notebooks/Unbinned_likelihood_with_SSC/SSC_contribution/SSC/mcmc_{likelihood}_cat={cat}_sample_{analysis_name}.pkl'
